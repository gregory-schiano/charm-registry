...
func (p *Postgres) CreatePackage(ctx context.Context, pkg core.Package) error {
	...
	err = p.queries().CreatePackage(ctx, sqlcdb.CreatePackageParams{
		...
		OciProject:         pkg.OCIProject,
		OciPushRobotID:     nullInt64(pkg.OCIPushRobot),
		OciPushRobotName:   robotUsername(pkg.OCIPushRobot),
		OciPushRobotSecret: robotSecret(pkg.OCIPushRobot),
		OciPullRobotID:     nullInt64(pkg.OCIPullRobot),
		OciPullRobotName:   robotUsername(pkg.OCIPullRobot),
		OciPullRobotSecret: robotSecret(pkg.OCIPullRobot),
		OciSyncedAt:        timestamptzPtr(pkg.OCISyncedAt),
